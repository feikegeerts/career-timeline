...
<style>
  ...
  .timeline-container::before {
    ...
    width: 2px;
    height: 100%;
    background: linear-gradient(to bottom, rgba(62, 132, 255, 0.2), rgba(62, 132, 255, 0.8), rgba(62, 132, 255, 0.2));
    transform: scaleY(0);
  ...
  .detailed-item::before {
    ...
    width: 16px;
    height: 16px;
    border: 2px solid rgba(62, 132, 255, 1);
    border-radius: 50%;
  ...
  .timeline-content:before {
    ...
    width: 0%;
    height: 3px;
    background: linear-gradient(90deg, #3e84ff, #6eb4ff);
  ...
  .back-button:hover {
    box-shadow: 0 5px 15px rgba(62, 132, 255, 0.2);
  }
